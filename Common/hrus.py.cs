...
namespace ArcSWAT3 {
    ...
    public class CreateHRUs {
        ...
        public async Task<bool> generateBasins(Form hrusForm) {
            ...
            double minDist;
            OSGeo.GDAL.Dataset hrusRasterDs = null;
            OSGeo.GDAL.Dataset slopeBandsDs = null;
            ...
            this.basins.Clear();
            using (var elevationDs = Gdal.Open(this._gv.demFile, Access.GA_ReadOnly))
            using (var basinDs = Gdal.Open(this._gv.basinFile, Access.GA_ReadOnly))
            using (var cropDs = Gdal.Open(this._gv.landuseFile, Access.GA_ReadOnly))
            using (var soilDs = Gdal.Open(this._gv.soilFile, Access.GA_ReadOnly))
            using (var slopeDs = Gdal.Open(this._gv.slopeFile, Access.GA_ReadOnly))
            {
                ...
                if (this._gv.isHUC || this._gv.isHAWQS) {
                    ...
                    using (var streamDs = Ogr.Open(this._gv.streamFile, 0)) {
                ...
                //    distDs.Dispose();
                //}
                //if (hrusRasterDs != null) {
                //    hrusRasterDs.Dispose();
                //}
                //if (slopeBandsDs != null) {
                //    slopeBandsDs.Dispose();
                //}
